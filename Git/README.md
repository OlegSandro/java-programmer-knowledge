...
- `git branch --set-upstream-to=<remote>/<destination> <source>` – установить связь между веткой \<source\> 
в локальном репозитории и веткой \<destination\> в удаленном репозитории \<remote\> (например, *origin*).
...
и загрузить туда содержимое ветки \<branch\> из локального репозитория, связав при этом указанные ветки.
