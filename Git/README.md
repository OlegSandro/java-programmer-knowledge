...
и удаленной веткой \<destination\>, которая находится на хосте с названием \<remote\> (например, *origin*).
...
- `git checkout --track <remote>/<branch>` – создать в локальном репозитории ветку с названием \<branch\>, 
скачать туда содержимое ветки \<branch\>, находящейся в удаленном репозитории на хосте \<remote\>,
и сразу переключиться на неё, связав при этом указанные ветки.
- `git checkout -b <destination> <remote>/<source>` – создать в локальном репозитории ветку с названием \<destination\>, 
скачать туда содержимое ветки \<source\>, находящейся в удаленном репозитории на хосте \<remote\>, 
и сразу переключиться на неё, связав при этом указанные ветки.
...
и загрузить туда содержимое ветки \<branch\>, находящейся в локальном репозитории, связав при этом указанные ветки.
- `git push -u <remote> <branch>` – создать в удаленном репозитории \<remote\> ветку с названием \<branch\> 
и загрузить туда содержимое ветки \<branch\>, находящейся в локальном репозитории, связав при этом указанные ветки.
- `git push` – загрузить содержимое текущей ветки локального репозитория 
в ранее связанную с ней ветку удаленного репозитория.